...
(function () {
    ...
    function iniciarNavbar() {
        ...
        function bindBusca(inputEl, suggestEl, formEl) {
            ...
            inputEl.addEventListener("input", function () {
                ...
                const textoSeguro = escapeHTML(inputEl.value)
                ...
                divTodos.innerHTML = "&#128269; Ver todos os resultados para <strong>" + textoSeguro + "</strong>";
    ...
    function iniciarResultados() {
        ...
        function executarBusca(query) {
            ...
            var querySeguro = escapeHTML(query);

            header.innerHTML =
                '<div class="d-flex align-items-center gap-3 flex-wrap"><div>' +
                '<h2><i class="bi bi-search me-2"></i>Resultados para <span class="query-badge">' + querySeguro + '</span></h2>' +
            ...
            if (resultados.length === 0) {
                ...
                semResultadosTexto.innerHTML =
                    'Não encontramos nada relacionado a "<strong>' + querySeguro + '</strong>". ' +
